...
- 🕵️ Is not a "special-character" version of the username (e.g. `admin` → `@dm!n`, using common leetspeak substitutions)
- ⚠️ Is not one of the most common, easily-guessed passwords (e.g. `123456`, `password`, `qwerty`)
